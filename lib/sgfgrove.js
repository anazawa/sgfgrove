(function () {
    ...
    SGFGrove.fileFormat({}, function () {
        ...
        this.properties = function (t, args) {
            ...
            that.merge = function (other) {
                ...
                Object.keys(other).forEach(function (ident) {
    ...
    SGFGrove.fileFormat({ FF: 4, GM: 1 }, function (FF) {
        ...
        Types.listOfPoint = (function (t) {
            ...
            var that = t.listOf(t.or(
                t.Point,
                t.scalar({
                    like: /^[a-zA-Z]{2}:[a-zA-Z]{2}$/,
                    parse: function (value) {
                        var x1 = coord.indexOf(value.charAt(0)),
                            y1 = coord.indexOf(value.charAt(1)),
                            x2 = coord.indexOf(value.charAt(3)),
                            y2 = coord.indexOf(value.charAt(4));
            ...
            that.parse = (function (superParse) {
                var array = [];
                return function (values) {
                    var result = superParse.call(this, values);
