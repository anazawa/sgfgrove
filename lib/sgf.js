(function (window) {
  ...
  SGF.FF = (function () {
    ...
    FF[1].types.Color = FF.types.scalar({
      name: 'Color',
      like: /^[BW]$/
    });

    FF[1].types.Triple = FF.types.scalar({
      name: 'Triple',
      like: /^[12]$/,
    ...
    FF[1].types.Real = FF.types.scalar({
      name: 'Real',
      like: /^[+-]?\d+(?:\.\d*)?$/,
      isa: isNumber,
      parse: parseFloat
    ...
    FF[1].types.Text = FF.types.scalar({
      name: 'Text',
      isa: isString,
    ...
    FF[1].types.None = FF.types.scalar({
      name: 'None',
      like: /^$/
    });

    FF[1].types.listOf = function (type) {
      return type && {
    ...
    FF[1][1].types = Object.create( FF[1].types );

    FF[1][1].types.Point = FF.types.scalar({
      name: 'Point',
      like: /^[a-s]{2}$/
    });

    FF[1][1].types.Move = FF.types.scalar({
      name: 'Move',
      like: /^[a-t]{2}$/
    });

    FF[1][1].props = FF[1].props( FF[1][1].types );

    FF[1][1].props.BR = FF[1][1].types.Text;
    FF[1][1].props.WR = FF[1][1].types.Text;
    FF[1][1].props.HA = FF[1][1].types.Number;
    FF[1][1].props.KM = FF[1][1].types.Real;

    FF[1][1].props.TB = FF[1][1].types.listOf( FF[1][1].types.Point );
    FF[1][1].props.TW = FF[1][1].types.listOf( FF[1][1].types.Point );
    FF[1][1].props.SC = FF[1][1].types.listOf( FF[1][1].types.Point );
    FF[1][1].props.RG = FF[1][1].types.listOf( FF[1][1].types.Point );
    ...
    FF[3].types = Object.create( FF[1].types );

    FF[3].types.Compose = function (left, right) {
      return left && right && {
    ...
    FF[3].props = function (types) {
      var t = types || FF[3].types;
    ...
    FF[3][1].types = Object.create( FF[3].types );

    FF[3][1].types.Point = FF[1][1].types.Point;
    FF[3][1].types.Move  = FF[1][1].types.Move;

    FF[3][1].props = FF[3].props( FF[3][1].types );

    FF[3][1].props.KO = FF[3][1].types.None;

    FF[3][1].props.RU = FF[3][1].types.Text;

    FF[3][1].props.BR = FF[3][1].types.Text;
    FF[3][1].props.WR = FF[3][1].types.Text;
    FF[3][1].props.HA = FF[3][1].types.Number;
    FF[3][1].props.KM = FF[3][1].types.Real;

    FF[3][1].props.TB = FF[3][1].types.listOf( FF[3][1].types.Point );
    FF[3][1].props.TW = FF[3][1].types.listOf( FF[3][1].types.Point );
    FF[3][1].props.TC = FF[3][1].types.Number;
    FF[3][1].props.SC = FF[3][1].types.listOf( FF[3][1].types.Point );
    FF[3][1].props.RG = FF[3][1].types.listOf( FF[3][1].types.Point );
    ...
    FF[4].types.Double = Object.create( FF[3].types.Triple );
    FF[4].types.Double.name = 'Double';
